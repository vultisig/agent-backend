...
func main() {
	...
	agentService := agent.NewAgentService(anthropicClient, msgRepo, convRepo, memRepo, redisClient, verifierClient, pluginService, logger, cfg.Anthropic.SummaryModel, cfg.Context)
